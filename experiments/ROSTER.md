...
|---|---|---|---|---|
| (A0030-error-at-fixed-stale-fraction-is-non-increasing-in-degree-on-a-trained-model-under-either-coherence-regime, cites-as-live) | On the Reddit post graph with a trained two-layer mean-aggregation checkpoint, absolute L2 error at a fixed uniform-random stale fraction is non-increasing in degree across deciles under both coherence regimes within a preregistered margin, and increasing under sum aggregation on the same architecture; relative L2 registered as a secondary predicted to fall under both | (A0012-stale-fraction-error-is-non-increasing-in-degree-under-mean-aggregation, cites-as-live); (A0001-sageconv-aggregates-by-mean-unless-told-otherwise, cites-as-live) | the median error in the top degree decile exceeds the bottom decile's by more than the margin under mean aggregation in absolute L2, or fails to exceed it under sum | open |

## Fallen

| hypothesis | statement | motivating claims | falsifier | status |
|---|---|---|---|---|
| (A0013-error-at-fixed-stale-fraction-is-non-increasing-in-degree-on-a-trained-model, cites-as-fallen) | Superseded after lab/017 and the fourth modelling round: the fixed fraction is realised by uniform insertion, whose deltas are coherent, so the condition splits into which neighbours are stale and how their deltas align, and the metric is named absolute L2 | (A0012-stale-fraction-error-is-non-increasing-in-degree-under-mean-aggregation, cites-as-live); (A0001-sageconv-aggregates-by-mean-unless-told-otherwise, cites-as-live) | the median error in the top degree decile exceeds the bottom decile's by more than the margin under mean aggregation, or fails to exceed it under sum | superseded |
