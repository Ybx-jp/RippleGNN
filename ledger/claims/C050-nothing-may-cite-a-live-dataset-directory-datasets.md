---
id: C050-nothing-may-cite-a-live-dataset-directory-datasets
kind: experiment-contract
grade: asserted
credence:
stated: 2026-08-27
author: backfill
source: "`CLAUDE.md`, `experiments/README.md`"
inventory_ref: B50
fingerprint: "Nothing may cite a live dataset directory"
locator:
---

## Statement

"Nothing may cite a live dataset directory"; `datasets.jsonl` pins the registry, "the bytes are not" committed
...
- **2026-08-27** · `corroborated` · grade `argued`
  ...
  - note: Standing; no experiment exists to test it.
