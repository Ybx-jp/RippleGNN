---
id: C042-run-py-is-itself-the-analysis-path-an
...
inventory_ref: B42
fingerprint: "run.py… is itself the analysis path. An analysis re-derived beside the production"
locator:
---

## Statement

"run.py… **is itself the analysis path**. An analysis re-derived beside the production code path is a second implementation that can be wrong on its own, and has been."
