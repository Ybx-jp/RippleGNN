---
id: C032-manifest-line-103-mutation-types-should-not-be
kind: error-model
grade: asserted
credence:
stated: 2026-08-27
author: backfill
source: "`MANIFEST.md`:103"
inventory_ref: B32
fingerprint: "should not be assumed equivalent"
locator:
---

## Statement

MANIFEST line 103: mutation types "should not be assumed equivalent" — insert/delete/feature asymmetry

## Depends on this

dl's R5; eval-meth's adequacy grid (mutation type × probe)
...
- **2026-08-27** · `open` · grade `argued`
  ...
  - note: Open. The only source that landed (DBToaster) says "deletions are duals of insertions and are omitted entirely" — no asymmetry claim.
